...
namespace Coldairarrow.Web.Areas.Base_SysManage.Controllers
{
    public class Base_UserController : BaseMvcController
    {
        ...
        public ActionResult GetDataList(Pagination pagination, string roleId, string departmentId, string keyword)
        {
            var dataList = _sysUserBus.GetDataList(pagination, false, null, roleId, departmentId, keyword);
