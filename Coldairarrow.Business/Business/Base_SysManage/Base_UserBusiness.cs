...
namespace Coldairarrow.Business.Base_SysManage
{
    public class Base_UserBusiness : BaseBusiness<Base_User>, IBase_UserBusiness, IDependency
    {
        ...
        public List<Base_UserDTO> GetDataList(Pagination pagination, bool all, string userId = null, string RoleId = null, string DepartmentId = null, string keyword = null)
        {
            ...
            {
                return list.Where(t => t.RoleIdList.Contains(RoleId)).ToList();
            }
            else
            {
                return list;
