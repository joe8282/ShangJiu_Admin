...
namespace Coldairarrow.Business.AdRecord
{
    ...
    {
        List<Dev_AdRecordDTO> GetDataList(Pagination pagination, bool all,  int typeId, string aboutId, string userId, string username, string keyword, int? Status, DateTime? _startTime, DateTime? _endTime, DateTime? startTime, DateTime? endTime);
